...
export const action = {
  ...
  dark: {
    hover: varAlpha(common.whiteChannel, 0.08),
    selected: varAlpha(common.whiteChannel, 0.16),
    focus: varAlpha(common.whiteChannel, 0.24),
    disabled: varAlpha(common.whiteChannel, 0.48),
    disabledBackground: varAlpha(common.whiteChannel, 0.24),
    hoverOpacity: 0.08,
    disabledOpacity: 0.48,
    active: grey[500],
  },
...
export const palette: Partial<Record<ThemeColorScheme, ColorSystemOptions['palette']>> = {
  ...
  dark: {
    ...basePalette,
    divider: varAlpha(common.whiteChannel, 0.12),
    text: text.dark,

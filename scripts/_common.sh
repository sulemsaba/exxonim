...
ADMIN_API_KEY="${ADMIN_API_KEY:-replace-with-a-strong-random-key}"
...
VITE_ADMIN_API_KEY="${VITE_ADMIN_API_KEY:-${ADMIN_API_KEY}}"

export BACKEND_DIR
export PUBLIC_DEV_PORT ADMIN_DEV_PORT BACKEND_DEV_PORT
export POSTGRES_HOST POSTGRES_PORT POSTGRES_ADMIN_USER POSTGRES_APP_USER POSTGRES_APP_PASSWORD POSTGRES_DB_NAME
export BACKEND_HTTP_URL PUBLIC_SITE_URL DATABASE_URL
export ADMIN_API_KEY JWT_SECRET JWT_ALGORITHM ACCESS_TOKEN_EXPIRE_MINUTES REFRESH_TOKEN_EXPIRE_DAYS CORS_ORIGINS
export VITE_API_URL VITE_ADMIN_API_KEY
